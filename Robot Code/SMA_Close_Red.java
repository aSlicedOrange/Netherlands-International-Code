...
public class SMA_Close_Red extends OpMode {
    ...
    double flywheelTargetRPM = 6000;
    double flywheelLowRPM = 1500;
    
    double[] startPos = {3658-850.9, 3403.6, 90};
    ...
    public void init(){
        ...
        chainSequence.add(new double[][] {{3658-936, 1919.7, 90}, {3658-484.2, 1941.2, 90}, {3658-406.4, 1866.9, 90}});
        chainSequence.add(new double[][] {{3658-999.5, 1360.9, 90}, {3658-215.9, 1397, 90}, {3658-698.5, 1447.8, 90}});
        chainSequence.add(new double[][] {{3658-330.2, 1440.2, 90}, {3658-215.9, 1440.2, 90}, {3658-869.9, 1936.7, 90}});
