...
public class SMA_Far_Blue extends OpMode {
    ...
    double[] startPos = {1422.4, 203.2, -90};
    ...
    public void init(){
        ...
        chainSequence.add(new double[][] {{1266.8, 889, -90}, {228.6, 889, -90}});
        chainErrorSequence.add(new double[][] {{20, 20, 0.5}, {10, 10, 0.1}});
        chainSequence.add(new double[][] {{228.6, 889, -90}});
